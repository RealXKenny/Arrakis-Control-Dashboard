  ...
  if (bases.length === 0) {
    return (
      ...
      >
        ...
        >
          There are currently no bases in this category.
        </div>
      </div>
    );
  }
      ...
      >
        ...
        >
          <div>
            ...
            <h2 style={styles.sectionTitle}>Bases</h2>
          </div>
          ...
          >
            {ownedBases.length} owned · {sharedBases.length} shared
          </div>
        </div>
