  ...
  return (
    <section style={{ ...styles.panel, width: '100%', boxSizing: 'border-box', overflow: 'hidden', padding: 24, marginBottom: 20 }}>
      ...
      <div style={{ marginTop: 18, padding: 14, border: `1px solid ${COLORS.border}`, borderRadius: 6, background: COLORS.panel }}>
        ...
        <input value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Enter an item name, such as Spice" style={{ width: '100%', boxSizing: 'border-box', padding: 12, background: '#17110d', border: `1px solid ${COLORS.border}`, borderRadius: 4, color: COLORS.text, outline: 'none' }} />
